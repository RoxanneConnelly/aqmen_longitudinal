...
Q-Step,University of Edinburgh,(September 2018)
...
20th September 2018 The day after Storm Ali
Corrected minor error

log using "$path5\mylog_date_initials_v2.txt, replace text"

should be

log using "$path5\mylog_date_initials_v2.txt", replace text

Version 8 pushed up to git repo


Previous Updates: 

12th September 2018 BBC Boss says wave reveal made it hard to keep Chris Evans.
...
Over the last decade and a half much of this material has been developed in 
close collaboration with Professor Paul Lambert, Stirling University. 
...
When using Stata at your own University you will have to change this to the 
correct location.
...
Task: Spend some time thinking about a suitable directory structure for one of 
your current or forthcoming projects or for a major project such as you PhD.
...
software and it also archives proceedings of Stata Users Group meetings and 
...
The instructors will point you to the relevant repository.
...
Save the zipped up folder to your machine or memory stick.
...
********************************************************************************
*
*	2. Summarize pid wave zhid zpno zdoby zpaynu2 zjbhr zjbcssm pacssm graduate 
*               zregage
*
*
********************************************************************************
